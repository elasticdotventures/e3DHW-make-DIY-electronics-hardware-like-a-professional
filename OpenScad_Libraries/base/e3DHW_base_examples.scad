...
/**
 ...
 Examples for library e3DHW_base_lib.1.2.scad
 */
...
// Print this example to fine tune the hardware data (in e3DHW_hardware_data.1.2.scad) for your 3D printer and filament.
