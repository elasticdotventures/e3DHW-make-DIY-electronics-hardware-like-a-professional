...
include <./base/e3DHW_base_lib.1.3.scad>
include <./base/e3DHW_array_lib.1.3.scad>
include <./base/e3DHW_addon_base.1.3.scad>
include <./base/e3DHW_hardware_data.1.3.scad> 
include <./base/e3DHW_DIN_rail_lib.1.3.scad>
include <./base/e3DHW_DIN_boxes_lib.1.3.scad>
include <./base/e3DHW_addon_terminal.1.3.scad>
include <./base/e3DHW_DIN_modules_A.1.3.scad>
